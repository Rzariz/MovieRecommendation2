...
//https://803b-103-153-105-175.ngrok.io
  getMovie = () => {
    const url = "https://7617-103-153-105-191.ngrok.io/get-movie";
    axios
      .get(url)
      .then(response => {
  ...
  likedMovie = () => {
    const url = "https://7617-103-153-105-191.ngrok.io/liked-movie";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
  ...
  unlikedMovie = () => {
    const url = "https://803b-103-153-105-175.ngrok.io/unliked-movie";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
  ...
  notWatched = () => {
    const url = "https://7617-103-153-105-191.ngrok.io/did-not-watch";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
